...
void MyHashTable::loadData(string archivo){
    ...
    if (data.is_open()) {
        ...
        while(getline(data, linea_)) {
            ...
            for (int cont_palabra = 0; cont_palabra < 4; cont_palabra++) {
...
// Metodo para aumentar el tama�o de la tabla y redistribuir nodos
...
// M�todo auxiliara para actualizar la informacion
